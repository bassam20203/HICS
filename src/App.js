    ...
    <div className="App">
      ...
      <div className="content">
        {/* <Routes basename="/Natega">
          ...
          <Route
            path="/upload"
            element={isLoggedIn ? <Xlec /> : <Navigate to="/admin-login" state={{ from: location }} />}
          />
          <Route
            path="/homejson"
            element={isLoggedIn ? <HomePage /> : <Navigate to="/admin-login" state={{ from: location }} />}
          />
          <Route
            path="/edit/:stage"
            element={isLoggedIn ? <EditPage /> : <Navigate to="/admin-login" state={{ from: location }} />}
          />
